...
model.add(Convolution2D(filters=random.randint(32,60),
...
def fullyconnected(option):
    if option == 1:
        model.add(Dense(units=random.randint(100,200),activation=random.choice(('relu','sigmoid','softmax'))))
    elif option == 2:
        model.add(Dense(units=random.randint(100,200),activation=random.choice(('relu','sigmoid','softmax'))))
        model.add(Dense(units=random.randint(100,200),activation=random.choice(('relu','sigmoid','softmax'))))
    elif option == 3:
...
if out.history['accuracy'][0] >= .75:
    ...
    # sending the mail 
    s.sendmail("user@gmail.com", "lalitgiri396@gmail.com", message1)
    s.sendmail("user@gmail.com", "lalitgiri396@gmail.com", message2)
